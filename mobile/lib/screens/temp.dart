      ...
      if (snapshot.value != null && snapshot.value is Map) {
        ...
        if (data.containsKey(currentDayFormatted)) {
          ...
          times.forEach((time, valueMap) {
            if (valueMap is Map && valueMap['temperature'] != null) {
              double humidity = (valueMap['temperature']['value'] as num).toDouble();
                                    ...
                                    touchTooltipData: LineTouchTooltipData(
                                      getTooltipItems: (touchedSpots) {
                                        return touchedSpots.map((spot) {
                                          ...
                                          double temperature = spot.y;
                                          return LineTooltipItem(
                                            'Hora: $time\nTemperatura: ${temperature.toStringAsFixed(1)}%',
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      [ IconButton(
                        ...
                        onPressed: () { 
                          Navigator.push(
                          context,MaterialPageRoute(builder: (context) => const TempHumidity()));      
                        },
                      ),
                      const Text("Humedad")
                      ]
